...
export const ADD_MAP_CONTOUR = 'add-map-contour';
export const ADD_MAP_DISPLACE = 'add-map-displace';
export const ADD_MAP_EASE = 'add-map-ease';
export const ADD_MAP_FLOW = 'add-map-flow';
export const ADD_MAP_ROTATE = 'add-map-rotate';
export const ADD_MAP_THRESHOLD = 'add-map-threshold';
export const ADD_MAP_WARP = 'add-map-warp';
export const ADD_NOISE = 'add-noise';
export const ADD_RIPPLE = 'add-ripple';
export const ADD_WAVE = 'add-wave';
export const AFTER_SPREAD = 'after-spread';
...
export const BEFORE_SPREAD = 'before-spread';
...
export const GRADIENTS_ARR = ['Gradient', 'RadialGradient', 'ConicGradient'];
...
export const ON_COORDINATES = 'on-coordinates';
...
export const PERMITTED_NOISE = ['random', 'bluenoise', 'ordered'];
